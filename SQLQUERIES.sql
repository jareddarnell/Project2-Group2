...
FROM 
	[Reservations] r 
	LEFT JOIN [Sites] s ON r.[SiteID] = s.[SiteID] 
	LEFT JOIN [Campgrounds] c ON s.[CampgroundID] = c.[CampgroundID]
WHERE
	r.[StartDate] BETWEEN '2018-Jun-01' AND '2018-Sep-30'
GROUP BY
	DATENAME(MONTH, r.[StartDate]),
	c.[Name]
ORDER BY
	c.[Name],
	Month;